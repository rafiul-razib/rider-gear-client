const bikes=[
    {
        ...
        intro: {
            ...
            ClaimedPeakPower:	"322",
            EstimatedDryWeight:	"193",
            PowerPerWeight:	"1.585"
        },
    ...
    },
    {
        ...
        intro: {
            ...
            ClaimedPeakPower:	"234",
            EstimatedDryWeight:	"152.2",
            PowerPerWeight:	"1.537"
        },
    ...
    },
    {
        ...
        intro: {
            ...
            ClaimedPeakPower:	"221",
            EstimatedDryWeight:	"172",
            PowerPerWeight:	"1.285"
        },
    ...
    },
    {
        ...
        intro: {
            ...
            ClaimedPeakPower:	"217",
            EstimatedDryWeight:	"177",
            PowerPerWeight:	"1.226"
        },
    ...
    },
    {
        ...
        intro: {
            ...
            ClaimedPeakPower:	"215",
            EstimatedDryWeight:	"180",
            PowerPerWeight:	"1.194"
        },
    ...
    },
    {
        ...
        intro: {
            ...
            ClaimedPeakPower:	"207",
            EstimatedDryWeight:	"173.3",
            PowerPerWeight:	"1.194"
        },
    ...
    },
    {
        ...
        intro: {
            ...
            ClaimedPeakPower:	"199.2",
            EstimatedDryWeight:	"171.1",
            PowerPerWeight:	"1.164"
        },
    ...
    },
    {
        ...
        intro: {
            ...
            ClaimedPeakPower:	"212",
            EstimatedDryWeight:	"184",
            PowerPerWeight:	"1.152"
        },
        description: "Yes, another from MV, and one to perhaps take more seriously. The Italian firm’s Brutale 1000 RR has been heavily reworked for 2020 and this initial, limited edition ‘Serie Oro’ version, complete with four extra (thanks to a different exhaust/ECU) and reduced weight (due to its carbon fibre wheels) is claimed by MV themselves to be ‘The fastest naked bike in the world’. Its price is an equally mind-bending £38,000.",
        price: 20100,
    ...
    },
    {
        ...
        intro: {
            ...
            ClaimedPeakPower:	"208",
            EstimatedDryWeight:	"186",
            PowerPerWeight:	"1.118"
        },
    ...
    },
    {
        ...
        intro: {
            ...
            ClaimedPeakPower:	"200",
            EstimatedDryWeight:	"179",
            PowerPerWeight:	"1.117"
        },
    ...
    },
    {
        ...
        intro: {
            ...
            ClaimedPeakPower:	"180",
            EstimatedDryWeight:	"118",
            PowerPerWeight:	"1.525"
        },
        description: "There’s no denying the Norton V4, ‘launched’ 2017, is surrounded by more than its fair share of controversy but the news this week that new owners TVS are looking for production staff, the fact that it is still available to order and the performance it promises demand that it’s included here. The relevant numbers are: a claimed 200bhp from its home-brewed (but Aprilia-inspired) 1200cc, 72-degree V4, a dry weight of 179kg from its aluminium tube frame and cycle parts including Ohlins suspension and Brembo brakes and more.. We’re just not sure when you might be able to get one…",
        price: 20100,
